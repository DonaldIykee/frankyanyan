                        ...
                        <div class="browser-stats">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-internet-explorer"></i>Internet Explorer<div
                                        class="text-success pull-right">16%<i class="fa fa-level-up"></i>
                                    </div>
                                </li>
                                <li><i class="fa fa-safari"></i>Safari<div class="text-danger pull-right">
                                        13%<i class="fa fa-level-down"></i></div>
                                </li>
                                ...
                                <li><i class="fa fa-tablet"></i>Mobile &amp; tablet<div class="text-success pull-right">
                                        4%<i class="fa fa-level-up"></i>
                                    </div>
                                </li>
                                <li><i class="fa fa-hashtag"></i>Others<div class="text-success pull-right">
                                        3%<i class="fa fa-level-up"></i></div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="project-stats">
                            <ul class="list-unstyled">
                                ...
                                <li>Personal Blog<span class="label label-default pull-right">48%</span>
                                </li>
