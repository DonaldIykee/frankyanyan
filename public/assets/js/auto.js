(function () {
    ...
    X.prototype.shouldTrackOutboundForm = function (a, b) {
        a = b(a.action);
        return (
            a.hostname != location.hostname && "http" == a.protocol.slice(0, 4)
        );
    };
    ...
    Y.prototype.shouldTrackOutboundLink = function (a, b) {
        ...
        b = b(a);
        return (
            b.hostname != location.hostname && "http" == b.protocol.slice(0, 4)
        );
    };
